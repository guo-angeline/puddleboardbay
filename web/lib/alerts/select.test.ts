...
describe("composeAlert", () => {
  it("names the spot for a single good window", () => {
    ...
    expect(body).toBe("Foster City Lagoons looks good Saturday. Conditions shift fast on the water.");
  ...
  it("summarizes extras with a +N more", () => {
    ...
    expect(body).toBe("Foster City Lagoons looks good Saturday, +1 more spots. Conditions shift fast on the water.");
  });
